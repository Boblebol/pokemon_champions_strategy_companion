  ...
  reference: {
    ...
    moves: {
      earthquake: {
        id: 'earthquake',
        name: 'Earthquake',
        localizedNames: { en: 'Earthquake', fr: 'Séisme' },
        type: 'Ground',
        category: 'Physical',
        power: 100,
        accuracy: 100,
      ...
      closecombat: {
        id: 'closecombat',
        name: 'Close Combat',
        localizedNames: { en: 'Close Combat', fr: 'Close Combat' },
        type: 'Fighting',
        category: 'Physical',
        power: 120,
        accuracy: 100,
      ...
      suckerpunch: {
        id: 'suckerpunch',
        name: 'Sucker Punch',
        localizedNames: { en: 'Sucker Punch', fr: 'Coup Bas' },
        type: 'Dark',
        category: 'Physical',
        power: 70,
        accuracy: 100,
      ...
      dragondance: {
        id: 'dragondance',
        name: 'Dragon Dance',
        localizedNames: { en: 'Dragon Dance', fr: 'Danse Draco' },
        type: 'Dragon',
        category: 'Status',
        pp: 20,
      },
      extremespeed: {
        id: 'extremespeed',
        name: 'Extreme Speed',
        localizedNames: { en: 'Extreme Speed', fr: 'Vitesse Extrême' },
        type: 'Normal',
        category: 'Physical',
        power: 80,
        accuracy: 100,
      ...
      roost: {
        id: 'roost',
        name: 'Roost',
        localizedNames: { en: 'Roost', fr: 'Atterrissage' },
        type: 'Flying',
        category: 'Status',
        pp: 5,
      },
      ...
      fireblast: {
        id: 'fireblast',
        name: 'Fire Blast',
        localizedNames: { en: 'Fire Blast', fr: 'Déflagration' },
        type: 'Fire',
        category: 'Special',
        power: 110,
        accuracy: 85,
      ...
      icebeam: {
        id: 'icebeam',
        name: 'Ice Beam',
        localizedNames: { en: 'Ice Beam', fr: 'Laser Glace' },
        type: 'Ice',
        category: 'Special',
        power: 90,
        accuracy: 100,
