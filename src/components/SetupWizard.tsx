...
const SETUP_WIZARD_REGION_ID = 'setup-wizard-panel';
  ...
  return (
    <section className={`setup-guide ${isOpen ? '' : 'collapsed'}`} aria-label="Assistant de départ">
      <div className="setup-guide-header">
        ...
        <button type="button" onClick={handleToggle} aria-expanded={isOpen} aria-controls={SETUP_WIZARD_REGION_ID}>
          {isOpen ? "Masquer l'assistant" : "Afficher l'assistant"}
        </button>
      </div>

      <div id={SETUP_WIZARD_REGION_ID}>
        {isOpen ? (
